...
namespace ScriptSharp
{
    ...
    public sealed class CompilerOptions
    {
        ...
        {
            get { return _docCommentFile; } 
            set { _docCommentFile = value; }
        }

        public bool EnableDocComments
        {
            get { return (_docCommentFile != null); }
        }

        public bool HasTestTypes
        {
            get { return _hasTestTypes; } 
            set { _hasTestTypes = value; }
        }

        public IStreamSourceResolver IncludeResolver
        {
            get { return _includeResolver; } 
            set { _includeResolver = value; }
        }
        ...
        {
            get { return _internalTestMode; } 
            set { _internalTestMode = value; }
        }

        public string InternalTestType
        {
            get { return _internalTestType; } 
            set { _internalTestType = value; }
        }
